...
// pub fn exe(vec: Vec<usize>) -> usize {
//     let i_vec: Vec<usize> = (0..*vec.len()).iter().collect();
//     let it: Vec<Vec<usize>> = iter::combination_iter(i_vec.to_vec(), 3).collect();

//     let mut set: HashSet<usize> = HashSet::new();
//     it.map(|v|{
//         v.into_iter(|u|vec[u]).sum()
//         if()
//     })
